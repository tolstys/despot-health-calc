...
$(function () {
	let items = {
		tanks: [[250, .03], [450, .05], [600, .10], [800, .06], [950, .07]],
		fencers: [[160, .05], [310, .06], [440, .07], [600, .08], [810, .09]],
		tricksters: [[100, .09], [160, .09], [200, .04], [380, .08], [520, .04]],
		fighters: [[120, .06], [230, .07], [450, .09], [600, .09], [770, .03]],
		healers: [[30, .10], [50, .10], [65, .10], [90, .10], [125, .10]],
		...
		mages: [[10, .07], [40, .10], [60, .04], [110, .08], [800, .06]],
